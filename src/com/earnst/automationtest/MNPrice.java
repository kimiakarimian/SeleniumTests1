...
//	
   ...
   if (zquant > 23 || lQuant > 12 || eQuant > 3 || gQuant > 15 ){
	...
	@Test
	@Parameters("browser")
	public void TestTotalPrice(String browserName){
	       if(browserName.equalsIgnoreCase("firefox")){
			...
			driver.findElement(By.id("line_item_quantity_zebra")).clear();
			driver.findElement(By.id("line_item_quantity_zebra")).sendKeys("8");
			
			driver.findElement(By.id("line_item_quantity_lion")).clear();
			driver.findElement(By.id("line_item_quantity_lion")).sendKeys("10");
	...
	//	
	   ...
	   if (zquant > 23 || lQuant > 12 || eQuant > 3 || gQuant > 15 ){
		   ...
		   Assert.assertTrue(true, "In Stock Value");
			...
			Assert.assertEquals(driver.findElement(By.xpath("/html/body/table[2]/tbody/tr[7]/td[2]")).getText(),"$426.00");
			//System.out.print(driver.findElement(By.id("taxes")).getAttribute(arg0));
			driver.quit();
		}
